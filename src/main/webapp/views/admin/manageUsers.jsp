        ...
        <%@ page import="com.volunteermanagementsystem.model.Organization" %>
            <%@ page import="java.util.List" %>
                <% if (session==null || session.getAttribute("role")==null ||
                    !session.getAttribute("role").equals("admin")) { response.sendRedirect(request.getContextPath()
                    + "/login.jsp" ); return; } List<User> users = (List<User>) request.getAttribute("users");
                        List<User> pendingUsers = (List<User>) request.getAttribute("pendingUsers");
                                List<Organization> pendingOrganizations = (List<Organization>)
                                        request.getAttribute("pendingOrganizations");
                                        ...
                                        boolean hasPendingOrganizations = pendingOrganizations != null &&
                                        !pendingOrganizations.isEmpty();
                                        ...
                                        <head>
                                            ...
                                            <title>
                                                <%= isPendingView ? "Pending Approvals" : "Manage Users" %> |
                                                    VolunteerBridge
                                            </title>
                                            <style>
                                                * {
                                        ...
                                        <body>
                                            ...
                                            <div class="sidebar">
                                                ...
                                                <nav class="sidebar-nav">
                                                    ...
                                                    <a href="<%= request.getContextPath() %>/AdminServlet?action=manageUsers"
                                                        class="nav-item <%= !isPendingView ? " active" : "" %>">👥
                                                        Manage Users</a>
                                                    <a href="<%= request.getContextPath() %>/AdminServlet?action=pendingUsers"
                                                        class="nav-item <%= isPendingView ? " active" : "" %>">⏳ Pending
                                                        Approvals</a>
                                            ...
                                            <main class="main-content">
                                                <div class="page-header">
                                                    ...
                                                    <p class="page-subtitle">
                                                        <%= isPendingView ? "Review and approve pending registrations"
                                                            : "View, approve, deactivate and reactivate user accounts"
                                                            %>
                                                    </p>
                                                </div>
                                                                ...
                                                                <% if (hasPendingOrganizations) { %>
                                                                                            ...
                                                                                            <td>
                                                                                                ...
                                                                                                <form
                                                                                                    ...
                                                                                                    <button
                                                                                                        ...
                                                                                                        onclick="return confirm('Reject this organization?')">❌
                                                                                                        Reject</button>
                                                                                                </form>
                                                                                            </td>
                                                                                        </tr>
                                                                    ...
                                                                    <% } %>
                                                                        ...
                                                                        <% if (hasPendingUsers) { %>
                                                                            <div class="table-card">
                                                                                <div class="table-card-header">
                                                                                    <h2>🙋 Pending Volunteers (<%=
                                                                                            pendingUsers.size() %>)</h2>
                                                                                </div>
                                                                                <div class="table-wrapper">
                                                                                    <table>
                                                                                        <thead>
                                                                                        ...
                                                                                        <% if (!isPendingView) { %>
                                                                                            <div class="table-card">
                                                                                                <div class="table-card-header"
                                                                                                    ...
                                                                                                    <div>
                                                                                                        <% String
                                                                                                            titleRoleFilter=request.getParameter("role");
                                                                                                            %>
                                                                                                            <h2>👥 <%=
                                                                                                                    (titleRoleFilter
                                                                                                                    !=null
                                                                                                                    &&
                                                                                                                    !titleRoleFilter.trim().isEmpty())
                                                                                                                    ?
                                                                                                                    (titleRoleFilter.substring(0,
                                                                                                                    1).toUpperCase()
                                                                                                                    +
                                                                                                                    titleRoleFilter.substring(1).toLowerCase()
                                                                                                                    + "s"
                                                                                                                    )
                                                                                                                    : "All Users"
                                                                                                                    %>
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <select
                                                                                                            ...
                                                                                                            style="padding: 8px 12px; border: 1px solid #d1d5db; border-radius: 6px; font-size: 14px; outline: none; background-color: white; cursor: pointer;">
                                                                                                            <option
                                                                                                                value="">
                                                                                                                All
                                                                                                                Status
                                                                                                        ...
                                                                                                        <input
                                                                                                            ...
                                                                                                            style="padding: 8px 12px; border: 1px solid #d1d5db; border-radius: 6px; font-size: 14px; width: 280px; outline: none; transition: border-color 0.2s;"
                                                                                                            onkeyup="if(event.key === 'Enter') filterUsersTable()">
                                                                                                        <button
                                                                                                            type="button"
                                                                                                            class="btn btn-primary"
                                                                                                            onclick="filterUsersTable()"
                                                                                                            style="margin: 0; padding: 8px 16px;">Search</button>
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div
                                                                                                    class="table-wrapper">
                                                                                                                    ...
                                                                                                                    <td
                                                                                                                        ...
                                                                                                                        <div
                                                                                                                            ...
                                                                                                                            <% if
                                                                                                                                ...
                                                                                                                                <% } else
                                                                                                                                    if
                                                                                                                                    ("deactivated".equals(u.getStatus()))
                                                                                                                                    {
                                                                                                                                    %>
                                                                                                                                    <form
                                                                                                                                        action="<%= request.getContextPath() %>/AdminServlet"
